...
import { mockTeamMembers } from "@/data/mockEngagementDetails"; // TODO: Task 9 — wire up data;
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage the professionals assigned to this engagement.
          </p>
        </div>
      </div>
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full h-8 text-xs text-navy-700 bg-slate-50 hover:bg-slate-100 hover:text-navy-950 gap-1.5 border-slate-200"
                    >
                  ...
                  <DialogContent className="sm:max-w-[425px]">
                    ...
                    <DialogFooter>
                      ...
                      <Button type="submit" className="bg-navy-950 hover:bg-navy-900 text-white">
                        Assign Item
                      </Button>
                    </DialogFooter>
                  </DialogContent>
