        ...
        <div className="flex gap-4 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-3 mb-1">
              ...
              <Badge variant="outline" className="text-navy-950 border-navy-200">
                {status}
              </Badge>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              <Badge
                variant="secondary"
                className="bg-slate-50 text-slate-600 hover:bg-slate-100 px-3 py-1 font-medium border border-slate-200"
              >
