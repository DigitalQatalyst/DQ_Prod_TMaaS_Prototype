...
const TransformationJourneysSection = () => {
  ...
  const journeys = useMemo(() => {
    ...
    return targetNames
      ...
      .filter(Boolean) as unknown as typeof initialServices;
  }, []);

  if (Array.from(journeys as readonly unknown[]).length === 0) return null;
      ...
      <div className="mx-auto max-w-[1200px]">
        <div className="mb-10 flex flex-col justify-between gap-6 md:flex-row md:items-end">
          ...
          <button
            type="button"
            onClick={() => {
              router.push("/marketplace?collection=bundles");
              window.scrollTo(0, 0);
            }}
