      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="min-w-0">
            ...
            <div className="animate-fade-in-up animation-delay-300 mt-8 flex flex-col items-stretch gap-3 sm:flex-row sm:items-center">
              {showDiscoveryCta ? (
                <Link href={discoveryPath} className={cn(btnPrimary, "group w-full sm:w-auto")}>
                  {DISCOVERY_SESSION_CTA_LABEL}
