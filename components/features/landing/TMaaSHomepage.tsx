      ...
      <div className="mx-auto max-w-7xl px-6 py-14">
          ...
          <div className="grid gap-10 sm:grid-cols-2">
            <div>
              ...
              <ul className="mt-4 space-y-2.5 text-sm text-navy-950">
                ...
                <li>
                  <Link href="/butler-demo" className="hover:text-orange-600">
                    Butler demo
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2.5 text-sm text-navy-950">
                ...
                <li>
                  <Link href="/dashboard/overview" className="hover:text-orange-600">
                    Dashboard
                  </Link>
                </li>
              </ul>
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-3 border-t border-navy-100 pt-6 text-xs text-gray-500 md:flex-row md:items-center">
          ...
          <div className="flex gap-4">
            <Link href="/legal/terms" className="hover:text-navy-950">
              Terms
            </Link>
            <Link href="/legal/privacy" className="hover:text-navy-950">
              Privacy
            </Link>
          </div>
        </div>
