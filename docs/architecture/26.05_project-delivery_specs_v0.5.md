...
- **Calculated RAG Prompts**: Tooltips and visual cues on the health indicators explain exactly which objective check failed (e.g., _"Amber because task X is marked Blocked"_).
