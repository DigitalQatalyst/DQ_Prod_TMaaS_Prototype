  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-6 pb-20 pt-28">
        <h1 className="text-2xl font-bold tracking-tight text-navy-950 md:text-3xl">
          Your cart
        </h1>
          ...
          <div className="mt-8 space-y-8">
            ...
            <div className="rounded-xl border border-navy-100 bg-slate-50/80 p-6">
              ...
              <p className="mt-2 text-xs text-gray-500">
                Pricing is confirmed during onboarding. You can adjust packages with your
                account team before work begins.
              </p>
