...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      "All content on the Platform — including but not limited to text, graphics, logos, icons, images, methodology frameworks (including the 6xD Framework), product and service names (including the DTM product suite and TMaaS service catalogue), and software — is the property of DigitalQatalyst DMCC or its licensors and is protected by applicable intellectual property laws in the UAE and internationally.",
...
const Terms = () => {
  return (
    <div className="min-h-screen bg-white">
      <Seo
        title={`Terms of Use | ${SEO_BRAND}`}
        description={`Terms governing your use of the ${PLATFORM_NAME_EXPANDED} platform.`}
        path="/legal/terms"
      />
      <LandingNavbar />
