...
import { mockEngagement, mockKRIs as initialKRIs, mockMilestones as initialMilestones, mockDeliverables as initialDeliverables } from "@/data/mockEngagementDetails";
...
export const DeliveryTab = () => {
  ...
  const handleAddDeliverable = () => {
    const targetMilestone = milestones.length > 0 ? milestones[0] : { id: 0, name: "Unassigned" };
