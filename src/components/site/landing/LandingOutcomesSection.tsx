      ...
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {OUTCOMES.map(({ tag, metric, metricLabel, title, body }) => (
            <div
              key={tag}
              className="group flex flex-col rounded-2xl border border-gray-200 bg-white p-8 transition-all duration-300 hover:border-dq-orange hover:shadow-xl"
            >
...
export default LandingOutcomesSection;
