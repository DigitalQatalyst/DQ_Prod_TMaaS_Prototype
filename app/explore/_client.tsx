      ...
      <MeshSection variant="heroLight" grid className="pt-32 pb-16">
        <div className="mx-auto max-w-7xl px-6">
          <SectionHeading
            ...
            description="Access our full range of transformation services, resources, and AI-powered tools organized across the 4D Framework."
          />
        </div>
      </MeshSection>
                      ...
                      {item.comingSoon ? (
                        <>
                          <div className="mb-4 flex items-center justify-between">
                            ...
                            <span className="rounded-full border border-navy-100 bg-white/60 px-3 py-1 text-xs font-semibold text-gray-700">
                              {item.badge}
                            </span>
                          </div>
      ...
      <MeshSection variant="ctaOrange" className="py-16">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <button
            ...
            className="mt-6 inline-flex items-center gap-2 rounded-full bg-orange-500 px-8 py-3 text-base font-semibold text-white transition hover:bg-orange-400"
          >
            <Brain size={20} />
            Start with TMaaS AI
          </button>
