...
import MarketplaceLaunchOffer from "@/components/features/marketplace/MarketplaceLaunchOffer";
import MarketplacePagination from "@/components/features/marketplace/MarketplacePagination";
...
export default function MarketplacePageClient() {
  ...
  const applyCollectionFilter = useCallback(
    ...
    [searchParams, router, scrollToCatalog]
  );
  ...
  const activeFilterChips = useMemo(() => {
    ...
    selectedCategories.forEach((cat) => {
      chips.push({
        key: `cat-${cat}`,
        label: `Category: ${marketplaceCategoryLabels[cat] ?? cat}`,
