  ...
  return (
    <DashboardLayout>
      <div className="max-w-6xl mx-auto space-y-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-navy-950">Organisation Profile</h1>
          <p className="mt-1 text-sm text-gray-500">Manage your organisation profile.</p>
        </div>
