      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            All active and historical service orders for your organisation.
          </p>
        </div>
        ...
        <div className="space-y-4">
          {mockOrders.map((order) => (
            <Card
              key={order.id}
              className="rounded-2xl border-navy-100 shadow-sm hover:shadow-md transition-shadow"
            >
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-1">
                      ...
                      <Badge
                        className={`text-[10px] font-bold border-none ${statusColors[order.status] ?? "bg-gray-100 text-gray-700"}`}
                      >
                        {order.status}
                      </Badge>
                    </div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">
                      {order.client} · Started {order.date}
                    </p>
                  </div>
                  <div className="text-right shrink-0">
                    ...
                    <Link
                      ...
                      className="mt-1 text-xs text-dq-orange hover:underline"
                    >
                      View details
                    </Link>
                  </div>
