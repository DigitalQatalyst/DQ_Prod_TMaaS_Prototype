              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-xs">
                    Tracking {activeEngagements.length} ongoing initiatives
                  </CardDescription>
                </div>
                <Link href="/dashboard/active-services">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="gap-2 text-xs font-semibold text-orange-600 hover:text-orange-700 hover:bg-orange-50"
                  >
                  ...
                  <div key={engagement.id} className="p-5 hover:bg-slate-50 transition-colors">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex gap-2">
                        <Badge
                          variant="secondary"
                          className="bg-white border-navy-100 text-[10px] font-semibold text-navy-950"
                        >
                          {engagement.status}
                        </Badge>
                        <Badge
                          variant="secondary"
                          className={`border-transparent text-[10px] font-bold ${engagement.health === "On Track" ? "bg-green-100 text-green-700" : "bg-orange-100 text-orange-700"}`}
                        >
                          {engagement.health}
                        </Badge>
                      </div>
          ...
          <Card className="rounded-2xl border-orange-200 bg-orange-50/30 shadow-sm">
            <CardHeader className="pb-2">
              ...
              <CardDescription className="text-xs text-gray-600">
                Based on your active engagements and operational profile.
              </CardDescription>
            </CardHeader>
                  ...
                  >
                    <div className="rounded-xl border border-orange-100 bg-white p-4 shadow-sm transition-all hover:border-orange-300 hover:shadow-md">
                      <div className="flex items-center justify-between mb-2">
                        <Badge
                          variant="secondary"
                          className="bg-orange-50 text-orange-700 border-none text-[9px] font-bold uppercase"
                        >
                          Recommended
                        </Badge>
                        <ArrowUpRight
                      ...
                      <h4 className="text-xs font-bold text-navy-950 mb-1">
              ...
              <div className="divide-y divide-navy-50">
                {recentUpdates.map((update) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`mt-0.5 shrink-0 rounded-full h-8 w-8 flex items-center justify-center ${update.bgColor} ${update.color}`}
                      >
                        <Icon size={14} />
                      </div>
                      <div>
                        <p className="text-xs font-semibold text-navy-950 leading-tight mb-1">
                          {update.title}
                        </p>
