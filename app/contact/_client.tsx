...
function inputClass(hasError?: string) {
  return [
    "w-full border-0 border-b bg-transparent px-0 py-2.5 text-[14px] text-gray-900 outline-none transition-colors focus:ring-0",
...
export default function ContactPageClient() {
  ...
  const [form, setForm] = useState<FormState>(() => {
    if (launchAdvisoryEnquiry) return { ...INITIAL, ...getLaunchAdvisoryFormDefaults() };
    if (!serviceEnquiry) return INITIAL;
    return { ...INITIAL, ...getServiceEnquiryFormDefaults(serviceEnquiry) };
  });
            ...
            <div className="mx-auto grid max-w-[1120px] gap-8 lg:grid-cols-12">
              ...
              <aside className="border-t border-gray-100 px-1 pt-8 lg:col-span-4 lg:border-t-0 lg:pt-0">
                ...
                <div className="mt-6 border-t border-gray-100 pt-5">
                  ...
                  <a href="tel:+97142666169" className="flex items-center gap-2.5 py-1">
