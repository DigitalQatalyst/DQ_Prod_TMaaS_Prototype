...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      "We collect information in two ways: information you provide to us directly, and information collected automatically when you use the Platform.",
      "Information you provide directly includes your name, work email address, organisation name, job role, and any context you share when submitting an enquiry through our contact form, requesting a service demonstration, or engaging with transformation services through the marketplace.",
      "Information collected automatically includes standard web server logs (IP address, browser type, pages visited, time and date of visit). We may use analytics tools to understand aggregate platform usage patterns. We do not use advertising cookies or cross-site behavioural tracking.",
      "Third-party connections: the Platform loads web fonts from Google Fonts (fonts.googleapis.com). This results in your browser making a connection to Google's servers, which may process your IP address. We do not control Google's data practices; please refer to Google's Privacy Policy for details.",
    ],
  },
  {
    ...
    body: [
      "We use the information you provide to respond to your enquiries, route your request to the appropriate DQ advisor or service team, and send you relevant information about TMaaS and related services where you have consented or where we have a legitimate interest in doing so.",
      "We use automatically collected information to maintain the security and performance of the Platform, understand how visitors use our marketplace, and improve our content and services.",
  ...
  },
  {
    ...
    body: [
      ...
      "Legitimate interests — where processing is necessary for our legitimate business interests (responding to enquiries, improving the Platform, maintaining records), and those interests are not overridden by your rights and freedoms.",
  ...
  },
  {
    ...
    heading: "10. Cookies",
    body: [
      "The Platform uses essential cookies required for the site to function correctly. We do not use advertising, tracking, or behavioural profiling cookies.",
      "As noted in Section 3, the Platform connects to Google Fonts to load typefaces. This is a functional dependency, not a tracking mechanism, but it involves a network request to Google's servers.",
      "You can control cookies through your browser settings. Disabling essential cookies may affect the functionality of parts of the Platform.",
    ],
  },
  {
    id: "security",
    heading: "11. Security",
    body: [
      "We implement appropriate technical and organisational measures to protect your personal data against unauthorised access, disclosure, alteration, loss, or destruction. All data transmitted between your browser and the Platform is encrypted using TLS.",
