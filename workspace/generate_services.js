...
const servicesList = [
  {
    ...
    cap: "strategy",
    type: "advisory",
    goals: ["grow-business", "modernise-technology"],
    px: "$2,500",
  },
  {
  ...
  {
    name: "Marketing Strategy Transformation",
    cap: "marketing",
    type: "advisory",
    goals: ["grow-business", "improve-cx"],
    px: "$2,200",
  },
  {
    ...
    cap: "data",
    type: "advisory",
    goals: ["modernise-technology", "improve-operations"],
    px: "$2,400",
  },
  {
  ...
  {
    name: "Innovation & Emerging Technology Strategy",
    cap: "strategy",
    type: "advisory",
    goals: ["modernise-technology", "grow-business"],
    px: "$2,600",
  },
  {
    name: "Digital Operating Model Design",
    cap: "operations",
    type: "design",
  ...
  {
    name: "Omnichannel Commerce Strategy",
    cap: "marketing",
    type: "advisory",
    goals: ["grow-business", "improve-cx"],
    px: "$2,100",
  },
  {
    ...
    cap: "engineering",
    type: "advisory",
    goals: ["modernise-technology", "strengthen-governance"],
    px: "$2,700",
  },
  {
    name: "Website Experience Modernisation",
    cap: "experience",
    type: "design",
    goals: ["improve-cx", "grow-business"],
    px: "$1,800",
  },
  {
    ...
    cap: "engineering",
    type: "build",
    goals: ["improve-cx", "automate-workflows"],
    px: "$3,200",
  },
  {
  ...
  {
    name: "Self-Service Portal Setup",
    cap: "engineering",
    type: "build",
    goals: ["automate-workflows", "improve-cx"],
    px: "$2,000",
  },
  {
  ...
  {
    name: "Business Intelligence Dashboard Setup",
    cap: "data",
    type: "build",
    goals: ["improve-operations", "grow-business"],
    px: "$1,900",
  },
  {
    ...
    cap: "data",
    type: "build",
    goals: ["automate-workflows", "improve-operations"],
    px: "$1,800",
  },
  {
  ...
  },
  {
    ...
    cap: "data",
    type: "build",
    goals: ["strengthen-governance", "improve-operations"],
    px: "$2,800",
  },
  {
    name: "Real-Time Analytics Enablement",
    cap: "data",
    type: "build",
    goals: ["modernise-technology", "improve-operations"],
    px: "$2,600",
  ...
  },
  {
    ...
    cap: "operations",
    type: "build",
    goals: ["improve-operations", "automate-workflows"],
    px: "$3,000",
  },
  {
  ...
  },
  {
    ...
    cap: "ai",
    type: "manage",
    goals: ["launch-ai", "improve-operations"],
    px: "$2,500",
  },
  {
    ...
    cap: "engineering",
    type: "manage",
    goals: ["automate-workflows", "modernise-technology"],
    px: "$2,100",
  },
  {
    name: "Managed Analytics Services",
    cap: "data",
    type: "manage",
    goals: ["improve-operations", "grow-business"],
    px: "$1,900",
...
const initialServices = servicesList.map((s, idx) => {
  ...
  return {
    ...
    description:
      "Expert " +
      s.name.toLowerCase() +
      " tailored to your business needs to drive growth and efficiency.",
