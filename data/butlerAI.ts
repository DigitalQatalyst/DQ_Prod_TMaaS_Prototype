...
export const transformationContext = {
  ...
  "internal-operations": {
    context:
      "Operational efficiency breaks down when core business systems operate in silos. Your ERP, HR, finance, and supply chain platforms each have their own data models and workflows, creating manual handoffs and reconciliation overhead.\n\nThe modern approach isn't replacing everything. It's building a digital core that orchestrates across your existing systems.",
    commonPatterns: [
...
export const mockedRecommendations = {
  ...
  "customer-experience-designing": {
    message:
      "Based on what you've told me, I'd suggest the Digital Experience Strategy service. You're already in discovery mode, this roadmap accelerates that by giving you a reference plan for a scalable, secure customer experience platform. It cuts execution planning time by over 50%. Ready to take a look?",
    serviceName: "Digital Experience Strategy",
    serviceUrl: "/service/1",
  },
  ...
  "customer-experience-optimizing": {
    message:
      "Based on what you've told me, I'd suggest the Digital Experience Strategy service as your baseline review. TMaaS optimization packages for ongoing performance are coming soon, but starting with the strategy roadmap helps you identify where your current platform needs strengthening. Ready to take a look?",
    serviceName: "Digital Experience Strategy",
    serviceUrl: "/service/1",
  },
  ...
  "internal-operations-designing": {
    message:
      "Based on what you've told me, I'd suggest the DWS Strategy service. You're in planning mode, this roadmap gives you a reference plan for your Digital Core Platform, cutting execution setup time by 35%. Ready to take a look?",
    serviceName: "DWS Strategy",
    serviceUrl: "/service/2",
  },
  "internal-operations-implementing": {
    message:
      "Based on what you've told me, I'd suggest the DWS Strategy service as your starting point. TMaaS specialist execution packages are coming soon, but having the strategy roadmap in place now means your deployment has a solid, compliant foundation to build from. Ready to take a look?",
    serviceName: "DWS Strategy",
    serviceUrl: "/service/2",
  },
  "internal-operations-optimizing": {
    message:
      "Based on what you've told me, I'd suggest the DWS Strategy service as a baseline review of your current platform. TMaaS optimization packages are coming soon. Getting the strategy roadmap right first ensures your efficiency efforts are targeted and effective. Ready to take a look?",
    serviceName: "DWS Strategy",
    serviceUrl: "/service/2",
  },
  ...
  "data-value-designing": {
    message:
      "Based on what you've told me, I'd suggest the Digital Intelligence and Analytics Strategy service. You're in planning mode, this roadmap gives you a reference plan for integrating your data systems and enabling actionable insights across the organization. Ready to take a look?",
    serviceName: "DI&A Strategy",
    serviceUrl: "/service/3",
  },
  "data-value-implementing": {
    message:
      "Based on what you've told me, I'd suggest the Digital Intelligence and Analytics Strategy service as your foundation. TMaaS specialist execution packages are coming soon, but a solid data roadmap now means your deployment is structured and scalable from day one. Ready to take a look?",
    serviceName: "DI&A Strategy",
    serviceUrl: "/service/3",
  },
  "data-value-optimizing": {
    message:
      "Based on what you've told me, I'd suggest the Digital Intelligence and Analytics Strategy service as a review of your current data architecture. TMaaS ongoing performance optimization is coming soon. This roadmap helps you identify the gaps between what you have and what you need. Ready to take a look?",
    serviceName: "DI&A Strategy",
    serviceUrl: "/service/3",
  },
  ...
  "devops-exploring": {
    message:
      "Based on what you've told me, I'd suggest the SecDevOps Strategy service. TMaaS packages this as a structured roadmap for defining your security posture, development efficiency, and delivery roadmap. At the exploration stage, this gives you a clear baseline to build from. Ready to take a look?",
    serviceName: "SecDevOps Strategy",
    serviceUrl: "/service/4",
  },
  "devops-designing": {
    message:
      "Based on what you've told me, I'd suggest the SecDevOps Strategy service. You're in planning mode, this roadmap gives you a reference plan for integrating security and DevOps practices across your delivery lifecycle. Ready to take a look?",
    serviceName: "SecDevOps Strategy",
    serviceUrl: "/service/4",
  },
  "devops-implementing": {
    message:
      "Based on what you've told me, I'd suggest the SecDevOps Strategy service as your foundation. TMaaS specialist execution packages are coming soon, but having your DevOps roadmap in place ensures your deployment is secure and structured from the start. Ready to take a look?",
    serviceName: "SecDevOps Strategy",
    serviceUrl: "/service/4",
  },
  "devops-optimizing": {
    message:
      "Based on what you've told me, I'd suggest the SecDevOps Strategy service as a maturity review of your current delivery setup. TMaaS ongoing optimization is coming soon. This roadmap helps you identify where your pipeline needs strengthening. Ready to take a look?",
    serviceName: "SecDevOps Strategy",
    serviceUrl: "/service/4",
  },
};
...
export const mockedFAQs = {
  "what-is-tmaas": {
    message:
      "TMaaS, Transformation as a Service, is a digital platform that helps organizations discover, explore, and activate digital transformation through structured services, AI-powered guidance, and collaborative workspaces. Instead of traditional consulting, TMaaS gives you proven transformation roadmaps you can adapt and activate.",
    options: ["Explore the services", "How does it work?", "Contact the team"],
  },
  "how-does-it-work": {
    message:
      "You describe your goals, Butler AI helps discover opportunities, and TMaaS recommends the right solution packages. Once you activate a package, a structured collaborative workspace is created for your team to drive results together.",
    options: ["Show me the services", "What does it cost?", "Get started"],
  },
  "what-does-it-cost": {
    message:
      "Pricing is scoped to your specific goals after a brief initial assessment. Speak to the TMaaS team to understand the right package for your organization.",
    options: ["Contact the team", "Explore the services"],
  },
  "how-to-get-started": {
    message:
      "Click Get Started to create your account, describe your goals to Butler AI, and explore the solution catalog. Butler will recommend a starting point based on your business reality.",
...
export const teamHandoff = {
  ...
  introduction:
    "Hi there! I'm Anthony, a Transformation Specialist at TMaaS. Butler filled me in on your interest. How can I help you today?",
